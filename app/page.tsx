...
const translations = {
  pt: {
    nav: { projetos: "Projetos", stack: "Stack", sobre: "Sobre", contato: "Contato" },
    hero: {
      ...
      desc: (
        <>
          ...
          otimização de <strong className="text-slate-100">Sistemas de Gestão</strong>.
        </>
      ),
      cta: "Vamos conversar"
    },
    ...
    projects: {
      ...
      subtitle: "Uma seleção de soluções que desenvolvi recentemente, focando em performance e inteligência artificial.",
      p1: {
  ...
  en: {
    ...
    hero: {
      ...
      desc: (
        <>
          ...
          optimizing <strong className="text-slate-100">Management Systems</strong>.
        </>
      ),
      cta: "Let's talk"
    },
    ...
    projects: {
      ...
      subtitle: "A selection of solutions I recently developed, focusing on performance and artificial intelligence.",
      p1: {
...
export default function Portfolio() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-slate-200 font-sans selection:bg-blue-500/30 overflow-x-hidden relative">
        ...
        <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-300">
          <div className="bg-[#0F0F0F] w-full max-w-6xl h-[85vh] rounded-3xl border border-white/10 overflow-hidden flex flex-col shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <div className="h-14 border-b border-white/10 flex justify-between items-center px-6 bg-[#151515]">
              ...
              <span className="text-xs font-mono text-slate-500 tracking-wider">LIVE PREVIEW • READ ONLY MODE</span>
              <button 
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <div className="flex justify-center pt-4">
            ...
            >
              ...
              <ChevronRight size={18} strokeWidth={3} className="text-slate-400"/>
            </Link>
          </div>
        </div>
      </section>
      ...
      {/* --- TECH STACK --- */}
      <section id="stack" className="py-12 border-y border-white/5 bg-white/[0.02] relative z-10 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-6">
          <p className="text-center text-slate-500 text-xs font-bold uppercase tracking-[0.2em] mb-10">{t.stack}</p>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-12 mb-16 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex gap-4 justify-center md:justify-start opacity-50 hover:opacity-100 transition-opacity">
                  <a href="https://github.com/iKevinsz" target="_blank" className="hover:text-white cursor-pointer"><Github size={20}/></a>
                  <a href="https://linkedin.com/in/kevin-rodrigo-000632209/" target="_blank" className="hover:text-blue-400 cursor-pointer"><Linkedin size={20}/></a>
              </div>
            </div>
          </div>
      ...
      <footer id="contato" className="py-20 bg-[#050505] relative z-10">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16">
            <SocialBtn href="https://github.com/iKevinsz" icon={<Github size={20}/>} label="GitHub" />
...
function TechItem({ icon, label, color }: { icon: any, label: string, color: string }) {
  return (
    <div className="flex flex-col items-center gap-3 group cursor-default">
      <div className={`p-4 bg-white/5 rounded-2xl border border-white/5 group-hover:border-white/20 group-hover:bg-white/10 transition-all ${color} group-hover:scale-110 shadow-lg`}>
        {icon}
      </div>
      <span className="font-bold text-slate-400 group-hover:text-white text-sm transition-colors">{label}</span>
    </div>
  )
}
  ...
  return (
    <div className={`bg-[#0F0F0F] border border-white/10 rounded-3xl p-8 transition-all duration-500 group flex flex-col h-full ${colors[color]} cursor-default`}>
      ...
      <div className="flex flex-wrap gap-2 mt-auto">
        {tags.map((tag: string) => (
          <span key={tag} className="text-xs font-bold px-3 py-1.5 rounded-lg bg-white/5 text-slate-300 border border-white/5 cursor-default">
            {tag}
          </span>
        ))}
      </div>
    ...
    <div className="min-h-full bg-[#F8FAFC] p-4 md:p-8 font-sans text-slate-900 flex flex-col">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full xl:w-auto">
             <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm min-w-[200px] cursor-default">
                <div className="flex justify-between items-start mb-2">
                   ...
                   <div className="p-1.5 bg-emerald-50 rounded-full text-emerald-500"><ArrowUpRight size={16}/></div>
                </div>
                <div className="text-2xl font-black text-slate-800">R$ 26.745,93</div>
             </div>

             <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm min-w-[200px] cursor-default">
                <div className="flex justify-between items-start mb-2">
                   <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Saídas</span>
                   <div className="p-1.5 bg-rose-50 rounded-full text-rose-500"><ArrowDownRight size={16}/></div>
                </div>
                <div className="text-2xl font-black text-slate-800">R$ 23.534,92</div>
             </div>

             <div className="bg-slate-900 p-5 rounded-3xl border border-slate-800 shadow-xl min-w-[200px] text-white cursor-default">
                <div className="flex justify-between items-start mb-2">
                   <span className="text-[10px] font-black uppercase tracking-widest opacity-60">Saldo</span>
                   <div className="p-1.5 bg-white/10 rounded-full"><Wallet size={16}/></div>
                </div>
       ...
       <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex flex-col justify-between h-[350px] cursor-default">
             <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex gap-3 text-[10px] font-bold uppercase">
                   <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-emerald-500"></div> Receita</div>
                   <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-rose-500"></div> Despesa</div>
                </div>
             </div>
             ...
             <div className="flex items-end justify-between h-full gap-2 pt-4 pb-2">
                {dadosGrafico.map((d, i) => (
                   <div 
                     ...
                     className={`flex flex-col items-center gap-2 w-full h-full justify-end cursor-pointer group transition-all duration-300 ${mesAtivo !== null && mesAtivo !== i ? 'opacity-30 grayscale' : ''}`}
                   >
                      ...
                      <span className="text-[9px] md:text-[10px] font-bold text-slate-400">{d.mes}</span>
                   </div>
                ))}
             </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 flex flex-col items-center justify-center relative h-[350px] cursor-default">
             <h3 className="font-bold text-slate-800 self-start mb-6">Maiores Despesas</h3>
             
             {/* Círculo SVG robusto */}
             <div className="relative w-48 h-48">
                <svg viewBox="0 0 100 100" className="transform -rotate-90 w-full h-full">
                  <circle cx="50" cy="50" r="40" fill="transparent" stroke="#f1f5f9" strokeWidth="12" />
                  <circle cx="50" cy="50" r="40" fill="transparent" stroke="#10b981" strokeWidth="12" strokeDasharray="172 251" strokeDashoffset="0" className="transition-all duration-1000 ease-out" />
                  <circle cx="50" cy="50" r="40" fill="transparent" stroke="#f43f5e" strokeWidth="12" strokeDasharray="110 251" strokeDashoffset="-175" className="transition-all duration-1000 ease-out" />
                  <circle cx="50" cy="50" r="40" fill="transparent" stroke="#3b82f6" strokeWidth="12" strokeDasharray="30 251" strokeDashoffset="-288" className="transition-all duration-1000 ease-out" />
                </svg>
             ...
             <div className="w-full mt-8 space-y-3 px-2">
                <div className="flex justify-between text-xs items-center border-b border-slate-50 pb-2">
                   <span className="flex items-center gap-2 font-bold text-slate-600">
                      <div className="w-2.5 h-2.5 rounded-full bg-emerald-500"></div> Despesas Fixas
                   </span>
                   <span className="font-bold text-slate-800">R$ 12.750,10</span>
                </div>
                <div className="flex justify-between text-xs items-center border-b border-slate-50 pb-2">
                   <span className="flex items-center gap-2 font-bold text-slate-600">
                      <div className="w-2.5 h-2.5 rounded-full bg-rose-500"></div> Cartão Crédito
                   </span>
                   <span className="font-bold text-slate-800">R$ 8.399,38</span>
                </div>
                <div className="flex justify-between text-xs items-center">
                   <span className="flex items-center gap-2 font-bold text-slate-600">
                      <div className="w-2.5 h-2.5 rounded-full bg-blue-500"></div> Diversos
                   </span>
             ...
             <table className="w-full text-sm min-w-[800px]">
                <thead className="bg-slate-50">
                   <tr className="border-b border-slate-200">
                      <th className="p-4 pl-6 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest sticky left-0 bg-slate-50 z-10 w-64">Categoria</th>
                      {dadosGrafico.slice(0, 6).map((d) => (
                         <th key={d.mes} className="p-4 text-center text-[10px] font-black text-slate-400 uppercase tracking-widest w-28">{d.mes}</th>
                      ))}
                   </tr>
                </thead>
                <tbody className="divide-y divide-slate-100">
                   <tr className="group hover:bg-slate-50 transition-colors">
                      <td className="p-0 border-r border-slate-100 relative sticky left-0 bg-white group-hover:bg-slate-50">
                         ...
                         <div className="p-4 pl-6 font-bold text-slate-700">Salário Mensal</div>
                      </td>
                      {dadosGrafico.slice(0, 6).map((_, i) => (
                         <td key={i} className="p-4 text-center font-bold text-xs text-emerald-600 bg-emerald-50/10 border-r border-slate-50">
                            R$ 4.500,00
                         </td>
                      ))}
                   </tr>
                   <tr className="group hover:bg-slate-50 transition-colors">
                      <td className="p-0 border-r border-slate-100 relative sticky left-0 bg-white group-hover:bg-slate-50">
                         ...
                         <div className="p-4 pl-6 font-bold text-slate-700">Aluguel</div>
                      </td>
                      {dadosGrafico.slice(0, 6).map((_, i) => (
                         <td key={i} className="p-4 text-center font-bold text-xs text-rose-500 bg-rose-50/10 border-r border-slate-50">
                            - R$ 1.800,00
                         </td>
                      ))}
                   </tr>
...
function GestaoDemo() {
  ...
  const [produtos, setProdutos] = useState([
    { id: 1, nome: "COCA ZERO - LATA", categoria: "BEBIDAS", preco: 6.00, imagem: "bg-red-100 text-red-600", icon: "🥤", status: "ATIVO" },
    { id: 2, nome: "COCA-COLA LATA", categoria: "BEBIDAS", preco: 6.00, imagem: "bg-red-600 text-white", icon: "🥤", status: "ATIVO" },
    { id: 3, nome: "GUARANÁ ANTARCTICA", categoria: "BEBIDAS", preco: 15.00, imagem: "bg-green-100 text-green-700", icon: "🥤", status: "ATIVO" },
    { id: 4, nome: "PIZZA 4 QUEIJOS", categoria: "PIZZAS", preco: 50.00, imagem: "bg-orange-100 text-orange-600", icon: "🍕", status: "ATIVO" },
    { id: 5, nome: "PIZZA CALABRESA", categoria: "PIZZAS", preco: 30.00, imagem: "bg-orange-50 text-orange-500", icon: "🍕", status: "ATIVO", tag: "VARIAÇÕES" },
  ]);
  ...
  return (
    <div className="flex h-full bg-[#F3F4F6] font-sans text-slate-600 overflow-hidden">
      ...
      <aside className="w-20 bg-white border-r border-slate-200 flex flex-col items-center py-6 gap-8 shadow-sm z-10 hidden md:flex cursor-default">
        <div className="p-3 bg-blue-900 text-white rounded-xl mb-4"><LayoutDashboard size={24} /></div>
        <div className="flex flex-col gap-6 w-full items-center">
           <div className="p-3 text-slate-400 hover:bg-slate-50 rounded-xl cursor-pointer transition-colors"><UtensilsCrossed size={24}/></div>
           <div className="p-3 bg-blue-50 text-blue-600 border-l-4 border-blue-600 w-full flex justify-center cursor-pointer"><ShoppingBag size={24}/></div>
           <div className="p-3 text-slate-400 hover:bg-slate-50 rounded-xl cursor-pointer transition-colors"><FileText size={24}/></div>
           <div className="p-3 text-slate-400 hover:bg-slate-50 rounded-xl cursor-pointer transition-colors"><Settings size={24}/></div>
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-slate-200 p-6 md:p-8 pb-6 shadow-sm z-10">
           <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-6">
              <div>
                 <h2 className="text-2xl font-bold text-slate-800 cursor-default">Catálogo de Produtos</h2>
                 <p className="text-sm text-slate-500 cursor-default">Gerencie preços, variações e estoque.</p>
              </div>
              <button 
                onClick={handleAdd}
           ...
           <div className="flex flex-col md:flex-row gap-3">
              ...
              <div className="flex gap-2">
                 ...
                 <div className="border border-slate-200 rounded-lg flex overflow-hidden">
                    <button className="p-2.5 bg-blue-50 text-blue-600 cursor-pointer"><List size={18}/></button>
                    <button className="p-2.5 bg-white text-slate-400 hover:bg-slate-50 cursor-pointer"><Grid size={18}/></button>
                 </div>
              </div>
           </div>
        </header>
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-3 bg-[#F8F9FA]">
           {filteredProducts.length === 0 ? (
              <div className="text-center py-20 text-slate-400 cursor-default">Nenhum produto encontrado.</div>
           ) : (
              filteredProducts.map((p) => (
                 <div key={p.id} className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4 hover:border-blue-300 transition-all group cursor-default">
                    
                    <div className="flex items-center gap-5 w-full md:w-auto">
                       <div className={`w-16 h-16 rounded-xl flex flex-col items-center justify-center shrink-0 ${p.imagem} relative overflow-hidden`}>
                       ...
                       <div>
                          <h3 className="font-bold text-slate-800 text-sm md:text-base">{p.nome}</h3>
                          <div className="flex items-center gap-2 mt-1">
                             <span className={`text-[10px] font-bold px-2 py-0.5 rounded ${p.status === 'ATIVO' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                                {p.status}
                             </span>
                             {p.tag && (
                    ...
                    <div className="flex items-center gap-6 w-full md:w-auto justify-between md:justify-end">
                       ...
                       <div className="flex gap-2">
                          <button className="p-2 border border-slate-200 rounded-lg text-blue-600 hover:bg-blue-50 transition-colors cursor-pointer" title="Editar">
                             <Pencil size={16} />
                          </button>
                          <button 
...
function FeedbackDemo() {
  ...
  const [sugestoes, setSugestoes] = useState([
    { 
      ...
      resumo: "Precisamos da homologação com a balança Toledo Prix 4. Atualmente só funciona com a Filizola...",
      modulo: "PDV",
      tipo: "MELHORIA",
      votos: 8,
      votado: false,
    ...
    { 
      ...
      resumo: "Implementar tema escuro no aplicativo do garçom. Em ambientes de balada ou restaurantes com luz baixa...",
    ...
    { 
      ...
      resumo: "Seria muito útil ter um botão de atalho direto para pagamento via PIX na tela principal de vendas...",
      modulo: "PDV",
      tipo: "MELHORIA",
      votos: 12,
      votado: true,
    ...
    <div className="flex flex-col h-full bg-[#F3F6F9] font-sans text-slate-600 overflow-hidden p-6 md:p-10">
      ...
      <div className="mb-8">
         <h2 className="text-2xl font-bold text-blue-900 flex items-center gap-2 cursor-default">
            <span className="p-1 border-2 border-blue-900 rounded-full"><Sparkles size={16}/></span>
            Sistema / Sugestões
         </h2>
         <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1 ml-9 cursor-default">Central de Melhorias e Feedback</p>
      </div>

      {/* Toolbar */}
      <div className="flex flex-col md:flex-row justify-between gap-4 mb-8">
         <button 
            className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-bold text-sm shadow-lg shadow-blue-200 transition-all active:scale-95 flex items-center gap-2 cursor-pointer"
         >
            <div className="bg-white/20 p-0.5 rounded-full"><Plus size={14}/></div>
      ...
      <div className="flex gap-8 border-b border-slate-200 mb-6 overflow-x-auto">
         <button 
            ...
            className={`pb-4 text-sm font-bold flex items-center gap-2 transition-colors whitespace-nowrap cursor-pointer ${activeTab === "votacao" ? "text-blue-600 border-b-2 border-blue-600" : "text-slate-400 hover:text-slate-600"}`}
         >
            <Sparkles size={16}/> Em Votação
         </button>
         <button 
            onClick={() => setActiveTab("desenvolvimento")}
            className={`pb-4 text-sm font-bold flex items-center gap-2 transition-colors whitespace-nowrap cursor-pointer ${activeTab === "desenvolvimento" ? "text-blue-600 border-b-2 border-blue-600" : "text-slate-400 hover:text-slate-600"}`}
         >
         ...
         <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-50">
               {listaFiltrada.length === 0 ? (
                   <tr><td colSpan={6} className="p-10 text-center text-slate-400 cursor-default">Nenhuma sugestão encontrada nesta aba.</td></tr>
               ) : (
                   listaFiltrada.map((s) => (
                      <tr key={s.id} className="hover:bg-slate-50 transition-colors group cursor-default">
                         <td className="px-6 py-5 text-slate-400 font-bold text-xs">{s.data}</td>
                         <td className="px-6 py-5 font-bold text-slate-700 text-base">{s.titulo}</td>
                         <td className="px-6 py-5 text-slate-500 text-xs leading-relaxed max-w-xs truncate" title={s.resumo}>{s.resumo}</td>
                         <td className="px-6 py-5 text-slate-500 font-medium">{s.modulo}</td>
                         <td className="px-6 py-5">
                            <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase ${
                               s.tipo === 'IMPORTANTE' ? 'bg-orange-50 text-orange-600' : 'bg-blue-50 text-blue-600'
                            }`}>
                               {s.tipo}
                            </span>
                         </td>
